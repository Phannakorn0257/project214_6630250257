...
.edit-container {
  margin: 20px;
  background-color: rgba(70, 60, 50, 0.7); /* สีน้ำตาลเข้ม */
  padding: 20px;
  border-radius: 16px;
...
input {
  ...
  font-size: 1rem;
  border-radius: 8px;
  border: 1px solid rgba(100, 90, 80, 0.7); /* สีน้ำตาลอ่อน */
  outline: none;
  transition: border-color 0.3s;
  background-color: rgba(80, 70, 60, 0.7); /* สีน้ำตาลเข้ม */
  color: #e0e0e0;
}

input:focus {
  border-color: #ffcc80; /* สีส้มอ่อน */
}

button {
  padding: 10px 20px;
  background-color: #ffcc80; /* สีส้มอ่อน */
  color: #333;
  border: none;
  border-radius: 8px;
  cursor: pointer;
...
button:hover {
  background-color: #ffb300; /* สีส้มเข้ม */
}
